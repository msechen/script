/*
#明星小店
10 9,18 9-25 8 * jd_star_shop.js
 */
const $ = new Env('明星小店');
...
!(async () => {
    ...
    let res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/DX3242/RandomShareCode@main/starShop.json')
    if(!res){
      await $.wait(1000)
        res = await getAuthorShareCode('https://gitee.com/ZFeng3242/RandomShareCode/raw/main/starShop.json')
    }
    if(res && res.length > 0){
        $.authorCodeList = getRandomArrayElements(res,1)[0];
    }
    $.inviteCodeList.push($.authorCodeList);
