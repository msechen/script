...
[task_local]
#骁龙
10 1,21 * * * https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_xiaolong.js, tag=骁龙, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "10 1,21 * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_xiaolong.js,tag=骁龙
===================================Surge================================
骁龙 = type=cron,cronexp="10 1,21 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_xiaolong.js
====================================小火箭=============================
骁龙 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_xiaolong.js, cronexpr="10 1,21 * * *", timeout=3600, enable=true
 */
const $ = new Env('骁龙');
