/*
 ...
 [task_local]
 #飞利浦组队
 50 0,12,22 * * * https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_teamFLP.js, tag=飞利浦组队, enabled=true

 ================Loon==============
 [Script]
 cron "50 0,12,22 * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_teamFLP.js, tag=飞利浦组队

 ===============Surge=================
 飞利浦组队 = type=cron,cronexp="50 0,12,22 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_teamFLP.js

 ============小火箭=========
 飞利浦组队 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_teamFLP.js, cronexpr="50 0,12,22 * * *", timeout=3600, enable=true
...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('./shareCodes/flp.json')
