...
[task_local]
#发财挖宝
22 8,20 * * * https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_fcwb.js, tag=发财挖宝, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "22 8,20 * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_fcwb.js,tag=发财挖宝
===================================Surge================================
发财挖宝 = type=cron,cronexp="22 8,20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_fcwb.js
====================================小火箭=============================
发财挖宝 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_fcwb.js, cronexpr="22 8,20 * * *", timeout=3600, enable=true
 */
...
!(async () => {
    ...
    const url = `./shareCodes/fcwb.json`
