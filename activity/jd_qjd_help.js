...
[task_local]
#全民抢京豆
20 1,16 * * * https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_qjd_help.js, tag=全民抢京豆, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "20 1,16 * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_qjd_help.js,tag=全民抢京豆

===============Surge=================
全民抢京豆 = type=cron,cronexp="20 1,16 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_qjd_help.js

============小火箭=========
全民抢京豆 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_qjd_help.js, cronexpr="20 1,16 * * *", timeout=3600, enable=true
...
function getAuthorShareCode() {
  return new Promise(resolve => {
    $.get({
      url: "./shareCodes/jd_updateBeanHome.json",
      headers: {
