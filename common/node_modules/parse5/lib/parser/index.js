...
const FormattingElementList = require('parse5/lib/parser/formatting-element-list');
const LocationInfoParserMixin = require('parse5/lib/extensions/location-info/parser-mixin');
const ErrorReportingParserMixin = require('parse5/lib/extensions/error-reporting/parser-mixin');
...
const ERR = require('parse5/lib/common/error-codes');
