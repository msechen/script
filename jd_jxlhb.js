...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://gitee.com/msewb/update/raw/master/jxhb.json')
  if (!res) {
    await $.wait(1000)
    res = await getAuthorShareCode('https://gitee.com/msewb/update/raw/master/jxhb.json')
  }
