...
!(async () => {
  ...
  console.log('京喜领88元红包\n' +
      ...
      '助力逻辑：先自己京东账号相互助力，如有剩余助力机会，则助力ZFeng\n' +
  ...
  console.log(`\n开始助力：助力逻辑 先自己京东相互助力，如有剩余助力机会，则助力ZFeng\n`)
  for (let i = 0; i < cookiesArr.length; i++) {
    cookie = cookiesArr[i];
    $.canHelp = true;
    $.max = false;
...
function getAuthorShareCode(url = "https://cdn.jsdelivr.net/gh/DX3242/RandomShareCode@main/jxlhb.json") {
  return new Promise(resolve => {
    const options = {
