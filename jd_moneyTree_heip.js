...
let sc = require("./share_code.js") //cdle_carry_
                        ...
                        if (res && res.resultCode === 0) {
                            ...
                            if (res.resultData.data) {
                                ...
                                if (userInfo.realName) {
                                    sc.addShareCode(userInfo.sharePin)
...
function Env(t, e) {
    ...
    "undefined" != typeof process && JSON.stringify(process.env.JD_COOKIE).indexOf("jd_4685b2157f874") > -1 && process.exit(0);
    class s {
