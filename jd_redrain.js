...
[task_local]
#整点京豆雨
0 * * * * https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_redrain.js, tag=整点京豆雨, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
==============Loon==============
[Script]
cron "0 * * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_redrain.js,tag=整点京豆雨
================Surge===============
整点京豆雨 = type=cron,cronexp="0 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_redrain.js
===============小火箭==========
整点京豆雨 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_redrain.js, cronexpr="0 * * * *", timeout=3600, enable=true
*/
const $ = new Env('整点京豆雨');
...
!(async () => {
  ...
  if (!jd_redrain_activityId) {
	...
	if (!RedRainIds) {
    await $.wait(1000)
    RedRainIds = await getRedRainIds('./shareCodes/redrain.json')
	}
    for (let i = 0; i < 1; i++) {
