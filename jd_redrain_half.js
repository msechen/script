...
[task_local]
#半点京豆雨
31 20-23/1 * * * https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_live_redrain.js, tag=半点京豆雨, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
==============Loon==============
[Script]
cron "31 20-23/1 * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_redrain_half.js,tag=半点京豆雨
================Surge===============
半点京豆雨 = type=cron,cronexp="31 20-23/1 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_redrain_half.js
===============小火箭==========
半点京豆雨 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_redrain_half.js, cronexpr="31 20-23/1 * * *", timeout=3600, enable=true
*/
const $ = new Env('半点京豆雨');
let allMessage = '', id = '';
...
!(async () => {
  ...
  if (!redIds) {
    await $.wait(1000)
    redIds = await getRedRainIds('./shareCodes/redrain_half.json')
  }
  if (!redIds.length) {
    $.log(`\n今日龙王🐲出差，天气晴朗☀️，改日再来～\n`);
    return;
