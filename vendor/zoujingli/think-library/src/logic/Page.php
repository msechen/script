...
class Page extends Logic
{
    ...
    public function init(Controller $controller)
    {
        ...
        if ($this->isPage) {
            ...
            // $html = "<div class='pagination-container nowrap'><span></span><br>{$page->render()}</div>";
            $html = "<div class='pagination-container nowrap'><span> {$page->total()} 条数据. </span><br>{$page->render()}</div>";
