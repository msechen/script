...
[task_local]
#JoyJd任务脚本
5 2,18 * * * https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_joyjd_open.js, tag=JoyJd任务脚本, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "5 2,18 * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_joyjd_open.js,tag=JoyJd任务脚本

===============Surge=================
JoyJd任务脚本 = type=cron,cronexp="5 2,18 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_joyjd_open.js

============小火箭=========
JoyJd任务脚本 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_joyjd_open.js, cronexpr="5 2,18 * * *", timeout=3600, enable=true
*/
...
!(async () => {
    ...
    if (!activityIDList) {
        $.log(`没有通用ID任务，尝试获取远程`);
        let data = await getData("./shareCodes/joyjd_open.json")
