module.exports ={"code":200,"dwsj_variable_data":{
    "reward_video":"这个暂时用不到,不要理",
    "dwsj_data":[{
        "user_ID":"这里填用户ID(推荐码都可以),在我的账户里面查看",
        "dwsj_token":"抓包任意域名为 sdsj.shandw.com 请求头上的 Authorization 值",
        "dwsj_body":"抓包任意域名为 sdsj.shandw.com 的请求体(body)内容",
        "dwsj_UA":"抓包任意域名为 sdsj.shandw.com 请求头上的 User-Agent 值"
        },{
