...
[task_local]
京东金融养猪猪
12 0-23/6 * * * https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_pigPet.js, tag=京东金融养猪猪, enabled=true
================Loon==============
[Script]
cron "12 0-23/6 * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_pigPet.js,tag=摇钱树助力
===============Surge=================
京东金融养猪猪 = type=cron,cronexp="12 0-23/6 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_pigPet.js
============小火箭=========
京东金融养猪猪 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/LF_JD/main/jd_pigPet.js, cronexpr="12 0-23/6 * * *", timeout=3600, enable=true
*
*/
const $ = new Env('金融养猪');
...
!(async () => {
  ...
  if (process.env.PIGPETSHARECODE) {
    ...
    let res = await getAuthorShareCode('./shareCodes/pigPet.json')
    if (res){
  ...
  console.log(`\n======开始大转盘助力======\n`);
  $.helpId = await getAuthorShareCode('./shareCodes/pig.json');
