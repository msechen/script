...
let shareId = ["G4LFeVIWco3B7fKz2T7AEg","10g5qikDOe8jDybN7sipecAdoUJQ3Dik"][Math.floor((Math.random()*2))]
let isLoginInfo = {};
$.shareCodes = [];
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/DX3242/updateTeam/master/shareCodes/pigPet.json')
  if (!res) {
  $.http.get({url: 'https://purge.jsdelivr.net/gh/DX3242/updateTeam@master/shareCodes/pigPet.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
  await $.wait(1000)
  res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/DX3242/updateTeam@master/shareCodes/pigPet.json')
  }
  $.shareCodes = [...(res || [])]
