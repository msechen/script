...
[task_local]
#京东秒秒币
20 7 * * * jd_ms.js, tag=京东秒秒币, img-url=, enabled=true

================Loon==============
[Script]
cron "20 7 * * *" script-path=jd_ms.js, tag=京东秒秒币

===============Surge=================
京东秒秒币 = type=cron,cronexp="20 7 * * *",wake-system=1,timeout=3600,script-path=jd_ms.js

============小火箭=========
京东秒秒币 = type=cron,script-path=jd_ms.js, cronexpr="20 7 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东秒秒币');
