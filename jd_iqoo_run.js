...
!(async () => {
    let res = [];
    try{res = await getAuthorShareCode('http://adguard.ipq.co/iqooCode.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('http://adguard.ipq.co/iqooCode.json');}catch (e) {}
 ...
 *JSDec - JSDec.js.org
 */
function getAA(_0x2ac542, _0x557cf9, _0x1dc011) {
    var _0x22ebd6 = {
        'hPswk': function(_0x7caabe, _0x4f856b) {
            return _0x7caabe + _0x4f856b;
        },
        'AShns': function(_0x3284d6, _0x2c8265) {
            return _0x3284d6 + _0x2c8265;
        },
        'ehytr': function(_0x5cea1f, _0x3a006f) {
            return _0x5cea1f + _0x3a006f;
        },
        'YdjND': function(_0x5cbae7, _0x521dd2) {
            return _0x5cbae7(_0x521dd2);
        }
    };
    let _0x210b66 = _0x22ebd6['hPswk'](_0x22ebd6['AShns'](_0x22ebd6['ehytr'](_0x1dc011, ',') + _0x2ac542 + ',', _0x557cf9), ',00eed6538f6e84b754ad2ab95b45c54f8');
    return _0x22ebd6['YdjND'](AA, _0x210b66);
};
