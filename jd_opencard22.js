...
!(async () => {
  ...
  $.MixNicks = ''
  $.inviteNick = 'TqfETAtYMx8TBjofdFjxKF4tLNYA4seuA67MOIYQxEk3Vl9+AVo4NF+tgyeIc6A6kdK3rLBQpEQH9V4tdrrh0w=='
...
async function run() {
  try {
    ...
    if(rewardBeanArr.includes(1) && (flag == 3 || flag == 11) && !$.activityEnd){
