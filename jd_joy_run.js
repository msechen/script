...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ['jd_723b4809692a6,jd_HJsqHppCgLwV,jd_44ed737886472,jd_4b32a5596fd39,jd_yvngJvzSUgIk'];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ['jd_723b4809692a6,jd_HJsqHppCgLwV,jd_44ed737886472,jd_4b32a5596fd39,jd_yvngJvzSUgIk'];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ["jd_723b4809692a6","jd_HJsqHppCgLwV","jd_44ed737886472","jd_4b32a5596fd39","jd_yvngJvzSUgIk"]
    ...
    if (cookiesArr[i]) {
      ...
      if ($.isNode()) {
        if (process.env.JOY_RUN_HELP_MYSELF) {
          console.log(`\n赛跑会先给账号内部助力,如您当前账户有剩下助力机会则为ZFeng1005助力\n`)
          let my_run_pins = [];
          ...
          let fixPins = run_pins.splice(run_pins.indexOf('jd_723b4809692a6'), 1);
          fixPins.push(...run_pins.splice(run_pins.indexOf('jd_HJsqHppCgLwV'), 1));
