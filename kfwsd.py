...
def exchange(ck):
    try:
        url = 'https://kraftheinzcrm.kraftheinz.net.cn/crm/public/index.php/api/v1/exchangeIntegral?value=%E4%BA%AC%E4%B8%9CE%E5%8D%A15%E5%85%83&phone=&type=%E8%A7%86%E9%A2%91%E5%8D%A1'
        headers = {
            ...
            'token': ck,
            'Origin': 'https://kraftheinzcrm.kraftheinz.net.cn',
